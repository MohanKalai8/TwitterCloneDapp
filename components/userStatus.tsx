import { ConnectWallet, Web3Button, useAddress, useContract, useDisconnect, useContractRead } from "@thirdweb-dev/react";
    ...
    return (
        <div className={styles.userContainer}>
            <div className={styles.statusHeader}>
                ...
                <button className={styles.logoutButton} onClick={() => disconnect()} >Disconnect</button>
            </div>
                ...
                <div className={styles.statusModalContainer}>
                    <div className={styles.statusModal}>
                        ...
                        <Web3Button
                            ...
                            isDisabled={newStatus.length === 0 || newStatus.length > 140}
                            onSuccess={() => {
